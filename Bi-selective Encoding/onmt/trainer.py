    ...
    def validate(self, valid_iter):
        ...
        for batch in valid_iter:
            ...
            if self.data_type == 'text':
                ...
                # -----new--------------------------------#
            template = inputters.make_features(batch, 'template', self.data_type)
            if self.data_type == 'text':
            ...
            outputs, attns, _ = self.model(src, tgt, template,src_lengths,template_lengths)
        ...
        for batch in true_batchs:
            ...
            for j in range(0, target_size-1, trunc_size):
                ...
                outputs, attns, dec_state = \
                    self.model(src, tgt, template,src_lengths,template_lengths, dec_state)
